...
def main():
    ...
    results_dir = os.path.join(_project_root, "consol_cfddata")
    csv_dir = os.path.join(_project_root, "csv_data")
    ...
    for idx, row in samples_df.iterrows():
        ...
        _comsol_script = os.path.join(_script_dir, "comsol单次执行脚本.py")
        cmd = [
            "python", _comsol_script,
            "--Ta", str(params['Ta']),
            "--Twa", str(params['Twa']),
            "--Tb", str(params['Tb']),
            "--Tt", str(params['Tt']),
